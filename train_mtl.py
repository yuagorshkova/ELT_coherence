...
from data import TextDataModule, sentence_tokenize_function, SentencesCollator
...
def main(args):
    ...
    sentences_collate_fn = SentencesCollator(max_length=32)
    ...
    if args.tokenized_datasets is not None:
        ...
        data_module = TextDataModule(
            train_data, 
            sentence_tokenize_function, 
            sentences_collate_fn, 
